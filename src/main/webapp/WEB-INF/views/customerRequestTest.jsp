...
<%--             <li><a href="${pageContext.servletContext.contextPath}/customer/viewMakeRequests">Requests</a></li>  Requests MEdical Services  --%>
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/customer/viewRequest">Appointments/Requests</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Appointments/Requests   <small>View</small></h1>
          </div>
<!--           <div class="col-md-2"> -->
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Appointments/Requests</h3>
              </div>
