   ...
   <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/doctor/viewReports">Reports
            </a></li>
          </ul>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Reports   <small>View Reports</small></h1>
          </div>
          <div class="col-md-2">
...
<%--                           <c:param name="serviceId" value="${tempRequest.serviceID}"></c:param> --%>
<%--                           </c:url>  --%>
<%--                            <c:url var = "tempRequest" value="/service/updateService"> --%>
<%--                           <c:param name="serviceId" value="${tempRequest.serviceID}"></c:param> --%>
<%--                           </c:url> --%>
                      ...
                      <tr>
                        ...
                        <td>${tempRequest.d1_actual}</td>
                        <td>${tempRequest.d1_normal}</td>
                        <td>${tempRequest.d2_actual}</td>
                        <td>${tempRequest.d2_normal}</td>
                        <td>${tempRequest.other_info}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">View Reports Description</h4>
      </div>
