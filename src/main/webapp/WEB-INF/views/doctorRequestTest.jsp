   ...
   <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/doctor/viewDoctorRequests">Requests</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Requests   <small>Manage Requests</small></h1>
          </div>
          <div class="col-md-2">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <c:forEach var ="tempRequest" items = "${requestlist}">
                          <c:url var = "accept" value="/request/acceptRequest">
                          <c:param name="id" value="${tempRequest.id}"></c:param>
                          </c:url> 
                           <c:url var = "decline" value="/request/declineRequest">
                          <c:param name="id" value="${tempRequest.id}"></c:param>
                          </c:url>
                      ...
                      <tr>
                        ...
                        <td><a class="btn btn-default" href="${accept}">Accept</a></td>
                        <td><a class="btn btn-danger" href="${decline}">Decline</a></td>
                      </tr>
                      </c:forEach>
                    </table>
              </div>
