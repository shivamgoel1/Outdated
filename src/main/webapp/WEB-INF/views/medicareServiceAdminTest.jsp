   ...
   <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/service/listServicesAdmin">Medical Services</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Services   <small>Manage</small></h1>
          </div>
<!--           <div class="col-md-2"> -->
...
<!--                 </div> -->
                ...
                <table class="table table-striped table-hover">
                      ...
                      <c:forEach var ="tempservice" items = "${service}">
                          <c:url var = "viewLink" value="/service/viewAdmin">
                          <c:param name="serviceId" value="${tempservice.medicare_service_id}"></c:param>
                          </c:url> 
                           <c:url var = "updateLink" value="/service/updateServiceAdmin">
                          <c:param name="serviceId" value="${tempservice.medicare_service_id}"></c:param>
                          </c:url>
                          
                           <c:url var = "delete" value="/service/delete">
                          <c:param name="serviceId" value="${tempservice.medicare_service_id}"></c:param>
                          </c:url>
