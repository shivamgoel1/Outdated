   ...
   <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${pageContext.servletContext.contextPath}/doctor/doctorListAdmin">Doctors</a></li>   
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Doctors   <small>Manage</small></h1>
          </div>
<!--           <div class="col-md-2"> -->
...
<!--                 </div> -->
                ...
                <table class="table table-striped table-hover">
                      ...
                      <c:forEach var ="tempdoctor" items = "${doctor}">
                          ...
                          <c:param name="serviceId" value="${tempdoctor.id}"></c:param>
                          </c:url> 
                           <c:url var = "updateLink" value="/doctor/update">
                          <c:param name="serviceId" value="${tempdoctor.id}"></c:param>
                          </c:url>
                          
                           <c:url var = "delete" value="/doctor/delete">
                          <c:param name="serviceId" value="${tempdoctor.id}"></c:param>
                          </c:url>
