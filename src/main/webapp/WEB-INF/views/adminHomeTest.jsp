  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="${pageContext.servletContext.contextPath}/admin/adminhome">Dashboard</a></li>
            ...
            <li><a href="${pageContext.servletContext.contextPath}/customer/allCustomers">Customers</a></li>
          </ul>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Admin  <small>Dashboard </small></h1>
          </div>
          <div class="col-md-2">
            <div class="dropdown create">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a type="button" data-toggle="modal" data-target="#UpdateProfile" href="updateAdmin">Update Profile</a></li>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> ${customers}</h2>
                    <h4>Customers</h4>
                  </div>
                </div>
<!--                 <div class="col-md-3"> -->
