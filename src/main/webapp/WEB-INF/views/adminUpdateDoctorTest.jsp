  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Doctor</h4>
      </div>
...
<%--  	<input id=serviceDateId type="hidden" value="${result.date}" name="date" required> --%>
      ...
      <a href="doctorListAdmin"> <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button></a>
