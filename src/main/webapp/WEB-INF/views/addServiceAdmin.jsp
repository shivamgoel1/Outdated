...
<form action="saveServiceAdmin" method="Post" modelAttribute="service">
  <div class="container">
   ...
   <label for="description"><b>Description</b></label>
	...
	<label for="d1_normal"><b>D1 Normal Range</b></label>
    <input id=d1_normal type="text" placeholder="Enter Range" value="${service.d1_normal}" name="d1_normal" required>
    
    <label for="d2_normal"><b>D2 Normal Range</b></label>
    <input id=d2_normal type="text" placeholder="Enter Range" value="${service.d2_normal}" name="d2_normal" required>
    ...
    <button type="submit" class="addbtn">Add Service</button>
  </div>
